    ...
    return [
      ...
      },
      {
        ...
        children: [
          ...
          {
            key: 'LeaveListPending',
            label: 'Leave List Pending',
            url: '/dashboard/leaves-hod/pending',
            parentKey: 'Leave',
            icon: createIcon(Circle, 'w-4 h-4'),
          },
          {
            key: 'LeaveListApproved',
            label: 'Leave List Approved',
            url: '/dashboard/leaves-hod/approved',
            parentKey: 'Leave',
            icon: createIcon(Circle, 'w-4 h-4'),
          },
          {
            key: 'LeaveListRejected',
            label: 'Leave List Rejected',
            url: '/dashboard/leaves-hod/rejected',
            parentKey: 'Leave',
            icon: createIcon(Circle, 'w-4 h-4'),
          },
        ],
